...
| `dwarf.png` | 20 images 64 × 64 (l'art de 48 px centré) : repos (9), marche (9), de face, de dos ; issues de `assets/dwarf/dwarf-idle.png` et `dwarf-walking.png` (grilles 3 × 3 de 48 px), `dwarf-48.png` et `dwarf-back.png` par `tools/import_anim.py` (une seule palette pour les quatre) | palette libre (15 couleurs) ; banque OBJ 1. Une seule image à la fois en VRAM (tuiles 64–127 de la zone partagée avec le marchand, le logo et les monstres), rechargée quand la boucle avance |
