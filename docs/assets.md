...
| `dwarf.png` | sprite 16 × 16, 4 images : repos A/B, creusement A/B | palette libre ; copiée dans la banque OBJ 1. Le casque au dernier niveau remplace l'index 5 (casque doré) à l'exécution |
