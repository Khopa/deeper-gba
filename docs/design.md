...
Écran de carte : fenêtre de quatre paliers, nœud courant en haut avec le nain (réduit de moitié par matrice affine, boucle de repos ; il marche vers le nœud choisi puis tourne le dos pour y entrer), lignes tracées
